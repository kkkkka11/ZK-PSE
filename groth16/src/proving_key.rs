    ...
    E::BaseField: PrimeField,
{
    ...
    pub fn pack_from_arkworks_proving_key(
        ...
        println!(
            "🔧 CRS pack: start (n={}, l={}, a={}, h={}, l_query={}, b_g1={}, b_g2={})",
            pp.n,
            pp.l,
            pk.a_query.len(),
            pk.h_query.len(),
        ...
        let packed_v = cfg_chunks!(pre_packed_v, pp.l)
            ...
            .collect::<Vec<_>>();
        println!(
            "  ├─ CRS pack v: {} chunks, {:.2}s",
            packed_v.len(),
            step_start.elapsed().as_secs_f64()
        );

        let step_start = Instant::now();
        let shares = cfg_into_iter!(0..pp.n)
            .map(|i| {
            ...
            .collect();
        println!(
            "  └─ CRS pack assemble shares: {} parties, {:.2}s (total {:.2}s)",
            pp.n,
            step_start.elapsed().as_secs_f64(),
